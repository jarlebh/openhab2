 ...
 *
 */
public class HeosResourceMetaData implements Serializable {
	...
	public HeosResourceMetaData(String id, String parentId, String title, String upnpClass, String desc) {
		super();
		this.id = id;
