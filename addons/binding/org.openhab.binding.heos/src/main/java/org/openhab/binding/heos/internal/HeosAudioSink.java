...
/**
 * This makes a Heos speaker to serve as an {@link AudioSink}-
 *
 * @author Jarle Hjortland - Initial contribution and API
 *
 */
public class HeosAudioSink implements AudioSink {
    ...
    private HeosPlayerHandler handler;
    private String callbackUrl;

    public HeosAudioSink(HeosPlayerHandler handler, AudioHTTPServer audioHTTPServer, String callbackUrl) {
    ...
    public void process(AudioStream audioStream) throws UnsupportedAudioFormatException {
        if (audioStream instanceof URLAudioStream) {
            ...
            if (!(audioStream instanceof FixedLengthAudioStream)) {
                ...
                if (callbackUrl != null) {
                    String relativeUrl = audioHTTPServer.serve((FixedLengthAudioStream) audioStream, 600).toString();
                    String url = null;
                    ...
                    if (AudioFormat.WAV.isCompatible(format)) {
                        ...
                        if (handler.getThing().getStatus() == ThingStatus.ONLINE) {
                            ...
                            logger.warn("Heos speaker '{}' is not online - status is {}", handler.getThing().getUID(),
    ...
    public PercentType getVolume() {
        return new PercentType(handler.getVolume());
    }
