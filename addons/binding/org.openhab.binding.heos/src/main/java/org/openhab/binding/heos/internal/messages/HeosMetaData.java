...
/**
 * The {@link HeosMetaData} is a datastructure to the metadata
 * of audio in the Sonos ecosystem
 * 
 * @author Karel Goderis - Initial contribution
 */
public class HeosMetaData {
	  ...
	  public HeosMetaData(String id, String parentId, String res, String streamContent, 
